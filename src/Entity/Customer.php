...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom doit faire entre 3 et 255 caractères", max=255, maxMessage="Le nom doit faire entre 3 et 255 caractères", allowEmptyString=true)
     */
    private $lastName;
    ...
    /**
     * Permet de récupérer le montant total des invoices
     * @Groups({"customers_read"})
     *
     * @return float
     */
    ...
    /**
     * Récupérer le montant total non payé des invoices (montant total hors factures payées ou annulées)
     * @Groups({"customers_read"})
     * @return float
     */
